...
public class WaveManager {
    ...
    public void spawnWave() {
        ...
        enemies.add(new EnemyA(1203, 0.1, 20, 1, 30, 30, 595, player));
        enemies.add(new EnemyB(-10, 0.1, 20, 1, 44, 44, 580, player));
        enemies.add(new EnemyC(-8, 0.1, 20, 1, 30, 30, 570,player));
        enemies.add(new SemiBoss(10, 0.1, 20, 20, 30, 100, 130,523,player));
